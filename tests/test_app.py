...
class TestApp:
    ...
    def test_calcular_suma(self, client):
        ...
        response = client.post(
            "/calcular",
            data=json.dumps({"numero1": 5, "numero2": 3, "operacion": "suma"}),
    ...
    def test_calcular_resta(self, client):
        ...
        response = client.post(
            "/calcular",
            data=json.dumps({"numero1": 10, "numero2": 3, "operacion": "resta"}),
            content_type="application/json",
        )
    ...
    def test_calcular_multiplicacion(self, client):
        ...
        response = client.post(
            "/calcular",
            data=json.dumps({"numero1": 4, "numero2": 5, "operacion": "multiplicacion"}),
            content_type="application/json",
        )
    ...
    def test_calcular_division(self, client):
        ...
        response = client.post(
            "/calcular",
            data=json.dumps({"numero1": 20, "numero2": 4, "operacion": "division"}),
            content_type="application/json",
        )
    ...
    def test_calcular_division_por_cero(self, client):
        ...
        response = client.post(
            "/calcular",
            data=json.dumps({"numero1": 10, "numero2": 0, "operacion": "division"}),
            content_type="application/json",
        )
    ...
    def test_calcular_operacion_invalida(self, client):
        ...
        response = client.post(
            "/calcular",
            data=json.dumps({"numero1": 5, "numero2": 3, "operacion": "potencia"}),
            content_type="application/json",
        )
    ...
    def test_calcular_con_decimales(self, client):
        ...
        response = client.post(
            "/calcular",
            data=json.dumps({"numero1": 5.5, "numero2": 2.5, "operacion": "suma"}),
            content_type="application/json",
        )
    ...
    def test_calcular_datos_invalidos(self, client):
        ...
        response = client.post(
            "/calcular",
            data=json.dumps({"numero1": "abc", "numero2": 3, "operacion": "suma"}),
            content_type="application/json",
        )
